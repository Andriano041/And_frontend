...
function plotDonut(indo, france, canada, usa, arge){
    // Data array
    var xArray = ["Indonesia", "France", "Canada", "USA", "Argentina"];
    var yArray = [indo, france, canada, usa, arge];
...
// View default donut chart on page load
plotDonut(55, 49, 44, 24, 15);
document.getElementById("id-indo").value = "55"
document.getElementById("id-indo").value = "48"
document.getElementById("id-indo").value = "44"
document.getElementById("id-indo").value = "24"
document.getElementById("id-indo").value = "80"
